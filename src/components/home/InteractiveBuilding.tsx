...
export function InteractiveBuilding({
  ...
  return (
    <div className="relative w-[90%] ml-auto mt-[68px] -translate-x-5 select-none lg:scale-[1.18] xl:scale-[1.22] 2xl:scale-[1.26] lg:translate-x-[12%] xl:translate-x-[15%] 2xl:translate-x-[18%] origin-bottom-right transition-transform duration-300">
