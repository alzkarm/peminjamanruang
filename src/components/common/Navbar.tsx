        ...
        <div className="bg-yarsi-dark text-emerald-100 text-xs px-4 py-1.5 flex items-center justify-between border-b border-emerald-900/20">
          <div className="flex items-center gap-2 max-w-7xl mx-auto w-full">
            ...
            <div className="hidden md:flex items-center gap-3 ml-auto text-emerald-200 text-[11px]">
              {mounted && isGuest && (
                <span className="inline-flex items-center gap-1 bg-amber-400/20 text-amber-300 px-2 py-0.5 rounded-full border border-amber-400/30 font-bold">
                  <Compass className="w-3 h-3" /> Mode Tamu (Guest Mode)
                </span>
              )}
            ...
            <div className="flex items-center gap-3">
              {mounted && !isGuest && currentUser ? (
                ...
                <div className="flex items-center gap-2">
                  <span className="hidden sm:inline-flex items-center gap-1 text-xs font-bold text-amber-700 bg-amber-50 px-2.5 py-1.5 rounded-xl border border-amber-200">
                    <Compass className="w-3.5 h-3.5 text-amber-600" />
                    <span>Mode Tamu</span>
                  </span>
                  <Link
                    href="/auth/login"
                    className="inline-flex items-center gap-2 px-4 py-2 text-xs sm:text-sm font-bold text-white bg-yarsi-primary hover:bg-yarsi-dark rounded-xl shadow-sm hover:shadow transition-all"
                  >
