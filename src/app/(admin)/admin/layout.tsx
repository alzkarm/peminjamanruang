...
export default function AdminLayout({
  ...
  if (!isAdmin) {
    return (
      <div className="flex min-h-[calc(100vh-140px)] items-center justify-center bg-[#f5f8f6] p-4">
        <div className="w-full max-w-md space-y-6 rounded-[18px_4px_18px_18px] border border-slate-200/80 bg-white p-8 text-center shadow-2xl">
