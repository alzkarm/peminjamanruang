...
import { formatDateIndo, formatShortDateIndo, getJakartaDateString } from '@/lib/utils';
...
export default function ReportsAnalyticsPage() {
  ...
  const [endDate, setEndDate] = useState(`${todayStr.slice(0, 7)}-${String(finalDay).padStart(2, '0')}`);
  ...
  const handleExportExcel = () => {
    ...
    XLSX.utils.book_append_sheet(workbook, worksheet, 'Peminjaman Ruang');
    XLSX.writeFile(workbook, `Laporan_Peminjaman_Ruang_YARSI_${startDate}_sd_${endDate}.xlsx`);
  };
