...
export default function AcademicBulkPage() {
  ...
  const handleImportSampleSchedule = () => {
    ...
    if (availableRooms.length === 0) {
      alert('Daftar ruangan dari API belum tersedia. Muat ulang data lalu coba lagi.');
      return;
    }
    ...
    const samplesWithApiRooms = samples.map((sample, index) => {
    ...
    bulkAddAcademicBlocks(samplesWithApiRooms);
